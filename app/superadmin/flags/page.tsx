...
import { FEATURE_PRICES_CENTAVOS, BASE_PRICE_CENTAVOS } from "@/control-plane/lib/pricing";
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <FlagMatrix
          flags={flags}
          tenants={tenantsForMatrix}
          pricesCentavos={FEATURE_PRICES_CENTAVOS}
          basePriceCentavos={BASE_PRICE_CENTAVOS}
        />
      </div>
    </div>
  );
