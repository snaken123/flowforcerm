...
By selecting "I Agree", creating an account, purchasing a membership, registering for classes, or continuing to use the NorthSouth Fight Sports app or services, you acknowledge that:
      ...
      <header className="border-b bg-background/95 backdrop-blur sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-sm leading-none">NorthSouth Fight Sports</p>
      ...
      <main className="flex-1 flex items-start justify-center px-4 py-10">
        <div className="w-full max-w-2xl space-y-6">
          ...
          {step.id === "privacy" && (
            <div className="space-y-5">
              ...
              <label className={`flex items-start gap-3 cursor-pointer ${!scrolled ? "opacity-40 pointer-events-none" : ""}`}>
                ...
                />
                <span className="text-sm">
                  I have read and understood the NorthSouth Fight Sports Privacy and Confidentiality Agreement and consent to the collection and use of my personal information as described, in accordance with the Philippine Data Privacy Act of 2012.
                </span>
              </label>
              {!scrolled && (
                <p className="text-xs text-muted-foreground">↓ Scroll through the document to enable agreement</p>
          ...
          {step.id === "welcome" && (
            <div className="space-y-6">
              <div>
                <h1 className="text-2xl font-bold">Welcome to NorthSouth Fight Sports! 🥋</h1>
                <p className="text-muted-foreground mt-1">
