        ...
        <div className="text-center space-y-3">
          <div className="flex justify-center">
            <div className="h-32 w-32 rounded-full overflow-hidden">
              <img src={logoUrl ?? "/logo.png"} alt={gymName} className="h-full w-full object-contain" />
            </div>
          </div>
          <h1 className="text-3xl font-bold tracking-widest text-white">{gymName}</h1>
          <p className="text-[#666] tracking-[0.2em] text-xs">{slogan ?? "Manage Less. Train More."}</p>
        </div>
