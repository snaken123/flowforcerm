      ...
      <div ref={cardRef} className="w-full max-w-[340px] rounded-3xl bg-white overflow-hidden shadow-2xl">
        ...
        <div className="flex flex-col items-center px-8 pt-6 pb-6 gap-4">
          ...
          <div className="flex items-center gap-4 w-full">
            <img src="/NS LOGO.png" alt="NorthSouth" className="h-20 w-20 object-contain shrink-0" />
            <div className="leading-tight">
              <p className="text-2xl font-extrabold uppercase tracking-widest text-gray-900">NorthSouth</p>
              <p className="text-sm uppercase tracking-[0.2em] text-gray-400">Fight Sports</p>
            </div>
          </div>
